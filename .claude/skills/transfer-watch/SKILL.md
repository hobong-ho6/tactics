...
3. 커널 적합도: fc26-heatmap.html의 MAPS를 파싱해 해당 슬롯 x에서 placedMap
   ...
   - **파싱 함정 (2026-07-30)**: MAPS 블록의 **마지막 항목(`st_false9`)은 뒤에 개행이 없어**
     ...
     저장값(하지무사 .923 / 은디아예 .883 / Jackson .752 / **Quiñones .832=st_false9/Attack** /
     만잠비 .817 / 바투리나 .711)이 재현되는지 회귀 검증할 것. 슬롯 x 버킷: RM 86 · LM 14 · CAM·ST 50 · RB 86.
...
- **판정 기준**: `last_news_date`(그 선수 이적설의 **최신 보도 날짜**)로부터 **14일 초과** 경과 →
