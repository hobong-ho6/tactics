...
> **2026-09-08 10:50 KST** · PC `AD03230205ui-iMac.local` · `main` · 마지막 커밋 **`387a079`** · **✅ origin 일치 · 워킹트리 깨끗**.
...
- **삭제 대상**(소진된 일회성): 헐 d1·d2 · `-liv-ipswich-d3` · `-atm-athletic-d2` · `-atm-athletic-d3`.
  ⭐ **자기를 띄운 스케줄 태스크는 그 세션 안에서 못 지운다** → 다음 세션에서 치운다. 나머지 소진분은 `enabled:false`라 방치해도 무해.
