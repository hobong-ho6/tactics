...
7. ✅ **[09-15 해소] 알렉사 푸리치 `sofascore_id` 재탐색 완료**(1100964로 정정) · **ATM map25 결손 5→3**
   (카스티요·푸리치 수집 완료, obs#746~748) — 잔여 3명(미겔 요렌테·알바로 모레노·호르헤 라하도)은
   공식전 출전 이력 자체가 없어 값을 발명하지 않기로 재확인(obs#748).
