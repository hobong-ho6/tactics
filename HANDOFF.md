...
6-1. **P2 · G13 확장 후보 2건 사전등록** — ⑴ `team_code IS NULL` 0건 불변식(09-12 정리로 0 달성, obs#618 규약 「NULL은 미배정」) ⑵ 「선수×시즌 클럽↔클럽 혼입」(중간 이적 예외 설계 필요). ⚠️ AVL 유효표본이 크게 늘었다(밍스 PL 15·게상 21·비조 13 등 731행 복귀) — `v_player_profile`·squad `rate_v` 재산출 여부 확인. · 팔레스트라·켄다·기튼스 **공식전 미출전 사유** 미수집.
