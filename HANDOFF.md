...
0-3a. **P1 · 다음 라운드(09-12~13)**: AVL–포레스트(PL R4, 재검증 7항) · LIV–풀럼(09-12 14:00Z — 이라올라 PPDA 회복 여부) · CHE·ATM 주말 경기. SofaScore는 하루 600+ 호출 뒤 403 — 회차 초반에 이벤트 축(collect_event.py)부터.
