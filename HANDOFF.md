...
> ⑷ ⛔ 리스 제임스 FC27 행 오염(로렌 제임스 값) 정정(obs#616). ⚠️ 음바예 `player_matches` 3212·3213(26-08 친선)이 `team_code=LIV`로 남아 있음 — 재점검 필요.
...
6-1. **P2 · 음바예 `player_matches` 3212·3213 `team_code=LIV` 재점검**(09-12 에이전트 발견 — 26-08 친선 2경기, 상대 NULL. PSG 소속 시기라 LIV 표기는 오류 가능성 높음, G13 대상) · 팔레스트라·켄다·기튼스 **공식전 미출전 사유**(부상/명단외) 미수집.
