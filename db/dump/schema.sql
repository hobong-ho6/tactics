...
CREATE TABLE player_card_items(
  ...
  source TEXT, confidence TEXT, acquisition TEXT, is_special INTEGER, first_seen TEXT, nation TEXT, league TEXT, chem_extra TEXT, is_icon INTEGER, is_hero INTEGER, height_cm INTEGER, weight_kg INTEGER, birthdate TEXT,
