...
export const CATEGORIES = [
  ...
  { key: 'finish',  label: '피니싱 무브 — 멈춘 뒤 R스틱 방향 입력' },
...
export const CELEBRATIONS = [
  ...
  // 러닝 무브 (뛰는 중 R스틱)
  { cat: 'finish', name_kr: '엄지 빨기', name_en: 'Thumb Suck', ps: '□ 홀드', xbox: 'X 홀드' },
  { cat: 'finish', name_kr: '팔 벌리기', name_en: 'Arms Out', ps: '□ 탭 → 홀드', xbox: 'X 탭 → 홀드' },
  { cat: 'finish', name_kr: '손목 플릭', name_en: 'Wrist Flick', ps: '△ 탭 → 홀드', xbox: 'Y 탭 → 홀드' },
  { cat: 'finish', name_kr: '비행기', name_en: 'Aeroplane', ps: 'R3 홀드', xbox: 'R3 홀드' },
  { cat: 'finish', name_kr: '하늘 가리키기', name_en: 'Point to Sky', ps: 'R스틱 ⇧ 홀드', xbox: 'R스틱 ⇧ 홀드' },
  { cat: 'finish', name_kr: '전화기', name_en: 'Telephone', ps: 'R스틱 ⇩ 홀드', xbox: 'R스틱 ⇩ 홀드' },
  { cat: 'finish', name_kr: '안 들려?', name_en: 'Can You Hear Me?', ps: 'R스틱 ⇦ 홀드', xbox: 'R스틱 ⇦ 홀드' },
  { cat: 'finish', name_kr: '손 벌리기', name_en: 'Hands Out', ps: 'R스틱 ⇨ 플릭 → ⇦ 홀드', xbox: '동일' },
  { cat: 'finish', name_kr: '컴온!', name_en: 'Come On!', ps: 'R스틱 ⇦ 플릭 → ⇨ 홀드', xbox: '동일' },
  { cat: 'finish', name_kr: '키스 날리기', name_en: 'Blow Kisses', ps: 'R스틱 ⇩ 플릭 → ⇧ 홀드', xbox: '동일' },
  { cat: 'finish', name_kr: '양팔 스윙', name_en: 'Double Arm Swing', ps: 'R스틱 ⇧ 플릭 → ⇩ 홀드', xbox: '동일' },
  { cat: 'finish', name_kr: '나는 새', name_en: 'Flying Bird', ps: 'R스틱 ⇨ 플릭 → ⇨ 홀드', xbox: '동일' },
  { cat: 'finish', name_kr: '머리 감싸기', name_en: 'Hand on Head', ps: 'R스틱 ⇦ 플릭 → ⇦ 홀드', xbox: '동일' },
  { cat: 'finish', name_kr: '하트', name_en: 'Heart Symbol', ps: 'R스틱 ⇩ 플릭 → ⇩ 홀드', xbox: '동일' },
  { cat: 'finish', name_kr: '양팔 위로', name_en: 'Arms Pointing Up', ps: 'R스틱 ⇧ 플릭 → ⇧ 홀드', xbox: '동일' },
  { cat: 'finish', name_kr: '풍차', name_en: 'Windmill', ps: 'R스틱 시계방향 회전', xbox: '동일' },
  { cat: 'finish', name_kr: '한 팔 들기', name_en: 'One Arm Raised', ps: '◯ 홀드', xbox: 'B 홀드' },
  { cat: 'finish', name_kr: '손가락 가리키기', name_en: 'Finger Points', ps: '◯ 탭 → 홀드', xbox: 'B 탭 → 홀드' },
